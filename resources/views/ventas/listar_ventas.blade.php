...
@section('breadcrumbs')
    <!--begin::Title-->
    <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bolder fs-1 m-0">Ventas
        <!--begin::Description-->
        <span class="page-desc text-muted fs-7 fw-semibold">$16.892.000</span>
        <!--end::Description-->
    </h1>
    <!--end::Title-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-gray-700">Ventas</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
        ...
        <div class="card-body pt-0">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                ...
                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-125px">No. Factura</th>
                    <th class="min-w-125px">Items</th>
                    <th class="min-w-125px">Valor venta</th>
