                ...
                <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                    ...
                    <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" action="{{ route('register') }}">
                        ...
                        <div class="text-center mb-11">
                            <!--begin::Title-->
                            <h1 class="text-gray-900 fw-bolder mb-3">Regístrese</h1>
                            <!--end::Title-->
                            <!--begin::Subtitle-->
...
{{--                        </div>--}}
                        ...
                        <div class="fv-row mb-8" data-kt-password-meter="true">
                            ...
                            <!--end::Wrapper-->
                            <!--begin::Hint-->
                            <div class="text-muted">Utilícese 8 o más caracteres con una mezcla de letras, números y símbolos.</div>
                            <!--end::Hint-->
                        </div>
                        <!--end::Input group=-->
                        <!--end::Input group=-->
                        ...
                        <div class="d-grid mb-10">
                            <button type="submit" id="kt_sign_up_submit" class="btn btn-primary">
                                ...
                                <span class="indicator-label">Regístrese</span>
                                <!--end::Indicator label-->
                        ...
                        <!--end::Submit button-->
                        <!--begin::Sign up-->
                        <div class="text-gray-500 text-center fw-semibold fs-6">Ya tengo una cuenta!
                            <a href="authentication/layouts/creative/sign-in.html" class="link-primary fw-semibold">Iniciar sesión</a></div>
                        <!--end::Sign up-->
                    </form>
                    <!--end::Form-->
                </div>
...
{{--                    </div>--}}
                    ...
                    <div class="d-flex fw-semibold text-primary fs-base gap-5">
                        ...
                        <a href="pages/contact.html" target="_blank">Contactenos</a>
                    </div>
                    <!--end::Links-->
                </div>
                <!--end::Footer-->
