        ...
        <div id="kt_app_header" class="app-header" data-kt-sticky="true" data-kt-sticky-activate="{default: false, lg: true}" data-kt-sticky-name="app-header-sticky" data-kt-sticky-offset="{default: false, lg: '300px'}">
            ...
            <div class="app-container container-xxl d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
                ...
                <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
                    <a href="index.html">
{{--                        <img alt="Logo" src="{{ asset('') }}" class="h-25px d-none d-lg-inline" />--}}
{{--                        <img alt="Logo" src="{{ asset('') }}" class="h-25px d-inline d-lg-none" />--}}
                    </a>
                </div>
                <!--end::Logo-->
                ...
                <div id="kt_app_hero_container" class="app-container container-xxl d-flex">
                    ...
                    <div class="d-flex flex-stack flex-wrap flex-lg-nowrap flex-row-fluid gap-4 gap-lg-10 mb-10">
                        ...
                        <div class="d-flex align-items-center me-3">
                            ...
                            <!--begin::Title-->
                            <h1 class="page-heading d-flex text-white fw-bolder fs-2 flex-column justify-content-center my-0">Almacén - Devs</h1>
                            <!--end::Title-->
                        </div>
                        <!--end::Heading-->
                        <!--begin::Items-->
                        <div class="d-flex gap-4 gap-lg-13">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <!--end::Number-->
                                <!--begin::Section-->
                                <div class="text-white opacity-50 fw-bold">Ventas</div>
                                <!--end::Section-->
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="d-flex flex-column">
                                ...
                                <!--end::Number-->
                                <!--begin::Section-->
                                <div class="text-white opacity-50 fw-bold">Compras</div>
                                <!--end::Section-->
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="d-flex flex-column">
                                <!--begin::Number-->
                                <span class="text-white fw-bold fs-3 mb-1">$9.758.000</span>
                                <!--end::Number-->
                                <!--begin::Section-->
                                <div class="text-white opacity-50 fw-bold">Servicios</div>
                                <!--end::Section-->
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="d-flex flex-column">
                                <!--begin::Number-->
                                <span class="text-white fw-bold fs-3 mb-1">$38.000.000</span>
                                <!--end::Number-->
                                <!--begin::Section-->
                                <div class="text-white opacity-50 fw-bold">Inventario</div>
                                <!--end::Section-->
                            </div>
                            <!--end::Item-->
                        </div>
                            ...
                            <div id="app_general">
                                ...
                                <div id="kt_app_toolbar" class="app-toolbar d-flex flex-column py-6">
                                    ...
                                    <div class="app-content-menu menu menu-rounded bg-gray-200 menu-state-bg flex-wrap fs-5 fw-bold mt-n15 pt-5 pb-0 mb-7 gap-1">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item m-0 p-0">
                                            <a class="menu-link py-3 px-4 {{ request()->routeIs('inventario') ? 'active' : '' }}" href="{{ route('inventario') }}">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item m-0 p-0">
                                            <a class="menu-link py-3 px-4 {{ request()->routeIs('compras') ? 'active' : '' }}" href="{{ route('compras') }}">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item m-0 p-0">
                                            <a class="menu-link py-3 px-4 {{ request()->routeIs('ventas') ? 'active' : '' }}" href="{{ route('ventas') }}">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item m-0 p-0">
                                            <a class="menu-link py-3 px-4 {{ request()->routeIs('configuracion') ? 'active' : '' }}" href="{{ route('configuracion') }}">
